...
public class MedicalServiceImplTest {
    PatientInfo patient1 = new PatientInfo("1", "Ivan", "Petrov", LocalDate.of(1985, 6,
    ...
    public void checkBloodPressureTest() {
        ...
        Mockito.when(patientInfoRepository.getById(Mockito.anyString())).thenReturn(patient1);
    ...
    public void checkBloodPressure_sendMessageTest() {
        // arrange
        PatientInfoRepository patientInfoRepository = Mockito.mock(PatientInfoRepository.class);
        Mockito.when(patientInfoRepository.getById("1")).thenReturn(patient1);
...
//    @Test
//    public void checkBloodPressure_and_sendMessageText_Test() { // Можно сделать так? Если нет, то почему?
//        // arrange
//        PatientInfoRepository patientInfoRepository = Mockito.mock(PatientInfoRepository.class);
//        Mockito.when(patientInfoRepository.getById("1")).thenReturn(patient1);
//
...
//        //assert
//        Mockito.verify(patientInfoRepository, Mockito.times(3)).getById("1");
//        Mockito.verify(alertService, Mockito.times(2)).send("Warning, patient with id: 1, need help");
//    }
}
